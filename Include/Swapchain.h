...
class Swapchain
{
 public:
   ...
   Swapchain(Descriptor&& p_descriptor)
   {
      ...
      VkResult result = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(vulkanDevice->GetPhysicalDevice(), p_descriptor.m_surface,
                                                                  &surfaceCapabilities);
      uint32_t presentModeCount = 0u;
      result = vkGetPhysicalDeviceSurfacePresentModesKHR(vulkanDevice->GetPhysicalDevice(), p_descriptor.m_surface,
      ...
      result =
          vkGetSwapchainImagesKHR(vulkanDevice->GetLogicalDevice(), m_swapchain, &swapchainImageCount, m_swapchainImages.data());
